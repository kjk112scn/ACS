...
### PassSchedule State Machine 리팩토링

| 항목 | 내용 |
|------|------|
| 상태 | 🚧 진행 중 (미완성) |
| 폴더 | `docs/features/active/PassSchedule_State_Machine_Refactoring/` |
| 파일 | `PassScheduleService.kt`, `PassScheduleController.kt` |
...
| - | c13d48e | fix(icd): trackingCMD offset 적용 복원 |
| - | (예정) | wip(passschedule): State Machine 리팩토링 진행 중 |
