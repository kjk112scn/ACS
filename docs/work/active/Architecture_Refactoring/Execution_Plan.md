...
│ HIGH (1개월)                                                 │
├─────────────────────────────────────────────────────────────┤
│ FE: 타입 단언 313건, 하드코딩 색상 475건, icdStore 175 ref  │
...
| 작업 | 현재 | 목표 |
|------|------|------|
| 개별 ref → shallowRef | ~175개 (안테나 81 + 보드상태 72 + 추적 13 등) | 5-10개 그룹 |
...
| 작업 | 건수 | 방법 |
|------|------|------|
| 하드코딩 색상 | 475건 | CSS 변수 전환 |
| as 타입 단언 | 313건 | Type Guard 적용 |
...
| icdStore ref 그룹 | ~175개 (개별) | 5-10개 (그룹화) |
