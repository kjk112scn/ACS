...
> ⚠️ **Phase 역할 분리 안내**
>
> 이 문서의 Phase 0-2는 **FE 세부 작업 순서**입니다.
> 메인 계획서의 Phase 1-4와는 다른 역할입니다.
>
> | 메인 계획서 | 이 문서 |
> |------------|---------|
> | Phase 3: FE 리팩토링 | Phase 0-2 전체가 해당 |
>
> 핵심 리팩토링(trackingStateStore)은 [RFC_SatelliteTrackingEngine.md](./RFC_SatelliteTrackingEngine.md) 참조
...
|------|------|----------|
| 1.0.0 | 2024-12 | 최초 작성 |
| 2.0.0 | 2024-12 | 거대 파일 목록, Phase별 계획 추가 |
| 3.0.0 | 2024-12 | Quasar 컴포넌트 표준화, 공통 패턴 섹션 추가 |
| 3.1.0 | 2026-01-07 | 최종 수정일 추가 |
| **3.2.0** | **2026-01-07** | **Phase 역할 분리 안내 추가** |
