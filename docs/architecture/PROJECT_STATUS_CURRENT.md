...
🔄 진행 중:
   - Architecture Refactoring (docs/work/active/)
   - PassSchedule 최적화
...
### 우선순위 2: 신규 문서 생성
3. **위성 추적 알고리즘 문서**
   - `docs/architecture/algorithms/Satellite_Tracking_Overview.md`
   - EphemerisService, OrekitCalculator 상세 설명

4. **ICD 통신 프로토콜 문서**
   - `docs/architecture/ICD_Communication.md`
   - ICDService, UdpFwICDService 프로토콜 명세

5. **에러 관리 시스템 문서**
   - `docs/guides/Hardware_Error_Messages.md` 업데이트
