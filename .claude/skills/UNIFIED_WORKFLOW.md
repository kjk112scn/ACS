...
| 규모 | 기준 | 경로 | 단계 |
|:----:|------|------|------|
| **S** | 단일 파일, 명확한 수정 | Express | 구현 → 빌드 → 완료 |
| **M** | 2-5 파일, 단일 이슈 | Standard | 분석 → 구현 → 검증 → 완료 |
| **L** | 6+ 파일, 복합 이슈 | Full | 6단계 전체 워크플로우 |
